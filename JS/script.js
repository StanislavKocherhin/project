...
// let number = 24;
// console.log(number);
// const SumNumberCount = 3;
// console.log(SumNumberCount);
// var point = 5;
// console.log(point);
            // урок по класификации типов данних 
// var obj = {
//     name: "Jhon",
//     age: 27,
//     married: true
...
// answers[1] = prompt("Какая ваша фамилая?", "");
...
//Тернарный оператор
// (num == 50) ? console.log('Everything is Ok') : console.log('Error');
